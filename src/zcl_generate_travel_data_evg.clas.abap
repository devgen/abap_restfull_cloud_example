CLASS zcl_generate_travel_data_evg DEFINITION
PUBLIC
 FINAL
 CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_EVG IMPLEMENTATION.

 METHOD if_oo_adt_classrun~main.
   DATA:itab TYPE TABLE OF ztravel_evg.
...
*   delete existing entries in the database table
   DELETE FROM ztravel_evg.

*   insert the new table entries
   INSERT ztravel_evg FROM TABLE @itab.

*   check the result
   SELECT * FROM ztravel_evg INTO TABLE @itab.
   out->write( sy-dbcnt ).
